...
import ListOrderContoller from "./controllers/order/ListOrderController";
...
router.get('/lastorder', isAuthenticated, new ListOrderContoller().handle);

router.get("/detailsorder", isAuthenticated, new DetailsOrderController().handle);

router.get("/endorder", isAuthenticated, new EndOrderController().handle);
